        ...
        <div className="backdrop-blur-xl bg-white/[0.04] border border-white/10 rounded-3xl p-10 md:p-16 shadow-2xl shadow-black/20">
          ...
          <div className="space-y-12 text-white/80 leading-8 text-[15px]">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-5">
                <li>Technical data automatically collected through the website, limited to:</li>
                <li>IP address;</li>
            ...
            <section>
              ...
              <p className="mb-8">We process your personal data only where permitted by law. Below you can find the breakthrough:</p>
